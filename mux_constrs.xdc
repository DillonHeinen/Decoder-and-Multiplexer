...
## Each pin corresponds to a device on the board. For example, pin V17 corresponds to enable, the rightmost switch.
...
## Switches
## Connects pin V17 (enable on the board) to input a in our gate module
set_property PACKAGE_PIN V17 [get_ports {select0}]	
...
set_property PACKAGE_PIN V16 [get_ports {select1}]			
## Sets the switch to use 3.3V logic
...
##Sch name = JB9
#set_property PACKAGE_PIN combo15 [get_ports {JB[6]}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {JB[6]}]
##Sch name = JB10 
#set_property PACKAGE_PIN combo16 [get_ports {JB[7]}]					
...
##USB HID (PS/2)
#set_property PACKAGE_PIN combo17 [get_ports PS2Clk]						
